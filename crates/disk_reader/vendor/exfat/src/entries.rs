...
impl EntryType {
    ...
    /// EndOfDirectory marker (0x00). Types 0x01-0x7F are *unused* entries
    /// that must be skipped, not treated as the end — Tesla-written
    /// filesystems are full of them (deleted clips, deleted Volume GUID).
