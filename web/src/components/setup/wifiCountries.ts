// ISO 3166-1 alpha-2 codes used for WiFi regulatory domains
...
const C: Record<string, string> = {
  ...
  CA: "Canada", CD: "Congo, Democratic Republic", CF: "Central African Republic", CG: "Congo",
  CH: "Switzerland", CI: "Cote d'Ivoire", CK: "Cook Islands", CL: "Chile",
  CM: "Cameroon", CN: "China", CO: "Colombia", CR: "Costa Rica",
  CU: "Cuba", CV: "Cape Verde", CW: "Curacao", CY: "Cyprus",
  ...
  GE: "Georgia", GF: "French Guiana", GH: "Ghana", GL: "Greenland",
  ...
  KI: "Kiribati", KM: "Comoros", KN: "Saint Kitts and Nevis", KP: "Korea, North",
  KR: "Korea, South", KW: "Kuwait", KY: "Cayman Islands", KZ: "Kazakhstan",
...
export const WIFI_COUNTRIES: [string, string][] = Object.entries(C).sort(
