...
function SizeInput({
  ...
  // Strip unit suffix to get the numeric display value
  ...
  return (
    <div className="rounded-lg border border-white/5 bg-white/[0.02] p-4">
      <div className="mb-2 flex items-center justify-between">
        ...
        <span className="text-sm font-mono text-blue-400">{displayText}</span>
      </div>
      <div className="flex gap-2">
        ...
        <select
          ...
          className="rounded-lg border border-white/10 bg-slate-900 px-2 py-2 text-sm text-slate-100 outline-none transition focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/25 [&>option]:bg-slate-900 [&>option]:text-slate-100"
        >
